...
def main():
    ...
    fixed acidity = st.number_input("Acidez fija", min_value=0.0, format="%.5f")
    volatile acidity = st.number_input("Ácidez volatil", min_value=0.0, format="%.2f")
    citric acid = st.number_input("Ácido cítrico", min_value=0.0, format="%.2f")
    residual sugar = st.number_input("Azucar residual", min_value=0.0, format="%.2f")
    chlorides = st.number_input("Cloruros", min_value=0.0, format="%.3f")
    free sulfur dioxide = st.number_input("Dioxido de azufre libre", min_value=1.0, format="%.2f")
    total sulfur dioxide = st.number_input("Dioxido de azufre total", min_value=0.0, format="%.1f")
